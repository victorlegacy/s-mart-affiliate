        ...
        <div class="sidebar-start">
          <div class="sidebar-head">
            <a href="/" class="logo-wrapper" title="Home">
              ...
              <img src="img/logo-white.png" width="100%" alt="Logo" />
            </a>
            <button
            ...
            <ul class="sidebar-body-menu">
              ...
              <li>
                ...
                <ul class="cat-sub-menu">
                  <li>
                    <a href="withdrawal-request.html" style="font-size: 12px;">View Withdrawal Request</a>
                  </li>
                  <li>
                    <a href="request-withdrawal.html" class="active" style="font-size: 12px;">Request For Withdrawal</a>
                  </li>
                </ul>
              </li>
              <li>
              ...
              <div class="col-lg-12">
                <form class="form" action="" method="">
                    <label class="form-label-wrapper">
                      ...
                      <input class="form-input" type="text" placeholder="Enter your account name" required>
                    </label>
                    <label class="form-label-wrapper">
                      <p class="form-label">Account Number</p>
                      <input class="form-input" type="text" placeholder="Enter your account number" required>
                    </label>

                    <label class="form-label-wrapper">
                        <p class="form-label">Bank Name</p>
                        <input class="form-input" type="text" placeholder="Enter your bank name" required>
                    </label>
